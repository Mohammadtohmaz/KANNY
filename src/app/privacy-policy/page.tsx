        ...
        <div className="space-y-8">
          <section className="gradient-border p-6">
            <div className="bg-[#141f3c] rounded-[calc(1rem-1px)]">
              <h2 className="text-2xl font-semibold mb-4 text-[#70FFEB]">1. Information We Collect</h2>
          ...
          <section className="gradient-border p-6">
            <div className="bg-[#141f3c] rounded-[calc(1rem-1px)]">
              <h2 className="text-2xl font-semibold mb-4 text-[#70FFEB]">2. How We Use Your Information</h2>
              <ul className="list-disc pl-6 text-gray-400 space-y-2">
          ...
          <section className="gradient-border p-6">
            <div className="bg-[#141f3c] rounded-[calc(1rem-1px)]">
              <h2 className="text-2xl font-semibold mb-4 text-[#70FFEB]">3. Data Security</h2>
          ...
          <section className="gradient-border p-6">
            <div className="bg-[#141f3c] rounded-[calc(1rem-1px)]">
              <h2 className="text-2xl font-semibold mb-4 text-[#70FFEB]">4. Your Rights</h2>
              <ul className="list-disc pl-6 text-gray-400 space-y-2">
          ...
          <section className="gradient-border p-6">
            <div className="bg-[#141f3c] rounded-[calc(1rem-1px)]">
              <h2 className="text-2xl font-semibold mb-4 text-[#70FFEB]">5. Contact Us</h2>
              <p className="text-gray-400">
                Questions regarding privacy practices can be directed to:{' '}
                <a href="mailto:privacy@arrowbets.com" className="text-[#70FFEB] hover:text-[#9FFFF4] transition-colors">
